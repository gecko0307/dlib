(function () {
    ...
    function getString(bufferOffset, bufferLen) {
      ...
      const buf = new Uint8Array(wasmMemory$1.buffer, bufferOffset, bufferLen);
      var s = "";
    ...
    function getFloat32Array(bufferOffset, bufferLen) {
      ...
      const buf = new Float32Array(wasmMemory$1.buffer, bufferOffset, bufferLen);
    ...
    request.onload = () => {
      ...
      WebAssembly.instantiate(wasmBuffer, importObject).then(result => {
        ...
        const gl = glInit(wasmMemory$2, canvas);
        const {
          exports
        } = result.instance;
