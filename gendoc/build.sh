...
for i in *.md; do 
    ...
    HTML="<html><head><link rel=\"stylesheet\" href=\"github-markdown.css\"><link rel=\"stylesheet\" href=\"code-default.css\"></head><body class=\"markdown-body\" style=\"margin-left: 20%; margin-right: 20%;\">${MD}</body></html>";
