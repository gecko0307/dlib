...
Documentation
-------------
HTML documentation can be generated from source code using ddox (run `dub build --build=docs && ddox generate-html docs.json docs`) or Doxygen (run `doxygen`). Be aware that documentation is currently incomplete.
